...
public class CelticCrossPrompt implements PromptStrategy<TarotRequestDto>{
    ...
    String base= """
            ...
            1. 핵심 상황 분석 (1-3번 카드 중심)
            2. 과거와 미래의 흐름 (4-6번 카드 중심)
            3. 내면과 외부 환경 (7-9번 카드 중심)
            4. 최종 결과와 조언 (10번 카드 중심)
            전체 길이는 1100-1300자 정도로 작성해주세요.
            
            응답구조: 아래 패턴으로
            <div class="result__section">
                <h3 class="result__section-title">{알맞는 이모지} 핵심 상황 분석</h3>
